 ...
 */
package com.ta.petro.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TapetroFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TapetroFulfilmentProcessConstants.PARENT_PROCESS);
