 ...
 */
package com.ta.petro.core.constants;

/**
 * Global class for all TapetroCore constants. You can add global constants for your extension into this class.
 */
public final class TapetroCoreConstants extends GeneratedTapetroCoreConstants
{
	public static final String EXTENSIONNAME = "tapetrocore";


	private TapetroCoreConstants()
	{
		//empty
	}
